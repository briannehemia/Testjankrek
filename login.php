...
<head> 
  ...
  <title>Pergudangan Duta Catering | Log in</title>
  <link rel="icon" type="image/png" href="../assets/image/LDP.png"/>
...
<div class="login-logo">
    <img style="height: 150px; margin-right: 70px; margin-bottom: 20px;" src="assets/image/Lpergudangan2.png">
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="db/ceklogin.php" method="POST">
      ...
      <!-- <div class="form-group has-feedback">
        <select type="level" class="form-control" placeholder="level" required>
