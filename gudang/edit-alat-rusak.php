            ...
            <div class="box box-primary">
             ...
             <!-- form start --> 
                ...
                <?php
                    ...
                    $tampil = $conn->editalatrusak($_GET['postid']);
                    while($fetch = $tampil->fetch_array()){ 
                ?>                    
                    
                <form role="form" action="../controller_gudang/alatrusakcontroller.php?action=edtalatrusak" Method="POST">
                <div class="box-body">
                    <input type="hidden" name="editid" value="<?php echo $fetch['id_alat_rusak'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <Textarea name="editpenanggungjawab" style="resize: none;" class="form-control" rows="1"  placeholder="Enter Penanggungjawab"><?php echo $fetch['penanggungjawab']?></Textarea>
                    </div>
