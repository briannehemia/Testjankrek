        ...
        <div class="col-lg-7">
            <div class="box box-primary">
                <div class="box-header with-border">
                 <h2 class="box-title"><b>Data Barang</b>
             ...
             <!-- form start --> 
                ...
                <?php
                    ...
                    $conn = new mdlbarang();
                    $tampil = $conn->edtfbarang($_GET['postid']);
                    while($fetch = $tampil->fetch_array()){ 
                ?>                    
                    
                <form role="form" action="../controller_suplayer/barangcontroller.php?action=edtbarang" Method="POST">
                <div class="box-body">
                    <input type="hidden" name="editid" value="<?php echo $fetch['id_barang'] ?>">
                     <label for="fornama_barang">Nama Barang</label>
                     <div class="form-group input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input readonly name="editnama_barang" type="text" class="form-control" id="fornama_barang" value="<?php echo $fetch['nama_barang'] ?>" placeholder="Enter Nama Barang" >
                    </div>
