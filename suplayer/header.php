...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <!-- <span class="logo-lg"><img height="47" style="margin-bottom:25px; margin-left: 30px; "  src="../assets/image/komaldev.png"></span> -->
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo "$loginnama";
                ?> 
                  <small><?php echo "$loginlevel";?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="profil-pemilik.php" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href=../controller/logcontroller.php?action=logout"> <i class="btn btn-default btn-flat">Log out</i></a>
                </div>
              </li>
            </ul>
          </li>
