      ...
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="mailchatpegawai.php"><i class="fa fa-inbox"></i> Inbox
                  <span class="label label-primary pull-right">12</span></a></li>
                <li><a href="formchatpegawai.php"><i class="fa fa-envelope-o"></i> Sent</a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
<form method="POST" action="../controller_manajer/chatpegawaicontroller.php?aksi=chatpegawai">
              ...
              <div style="width:220px;" class="form-group input-group">
                <input type="text" name="postsubjek" class="form-control" placeholder="Subjek">
              </div>
              ...
              <div class="form-group">
                  <label stye="padding-left:50px;" class="form-group">Pesan :</label>
                    <textarea name="postpesan" id="" class="form-control" style="height: 200px"></textarea>
              </div>
