<?php
	...
	class mdlalatrusak extends db_connect{	
		...
		public function edtfalat($postid){
			$con = $this->conn;
			$result = mysqli_query($con ,"select * from tbalatrusak where id_alat = '$postid'");
			return $result;
		}

		public function edtalat($id, $nama_alat, $jumlah, $penanggungjawab){
			$con = $this->conn;
			$result = mysqli_query($con,"edtalat tbalatrusak set nama_alat='$nama_alat', jumlah='$jumlah', penanggungjawab='$penanggungjawab' where id_alat='$id'");
			return $result;
		}
