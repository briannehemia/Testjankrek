      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
<form method="POST" action="../controller/requestController.php?aksi=dana">
              ...
              <span class="input-group-addon">Dana(Rp)</span>
                <input type="text" name="postjumlah" class="form-control" placeholder="Jumlah dana:">
              ...
              <div class="form-group">
                  <label stye="padding-left:50px;" class="form-group">keperluan :</label>
                    <textarea name="postkeperluan" id="" class="form-control" style="height: 200px"></textarea>
              </div>
              <div class="form-group">
