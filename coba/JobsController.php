...
// ADD LOWONGAN PEKERJAAN // ADD LOWONGAN PEKERJAAN // ADD LOWONGAN PEKERJAAN // ADD LOWONGAN PEKERJAAN // ADD LOWONGAN PEKERJAAN 
		...
		// add datapelamar dan datacv
		$conn->addlamaran($idlowongan, $nama, $keterangan, $jumlah, $syarat);

		// Log add data pelamar
		session_start();
		$loginnama = $_SESSION['nama'];
		$action = "Add Data";
		$keterangan = "Data yang telah di tambah adalah data dengan id pendaftar ".$idpendaftar ." dan Berikut detailnya : <br/>" ."
nama : " .$nama ."<br/>" ."
email : " .$email ."<br/>" ."
alamat : " .$alamat ."<br/>" ."
Nomor Telpon : " .$notelp;
...
// ADD PENGUJI WAWANCARA // ADD PENGUJI WAWANCARA // ADD PENGUJI WAWANCARA // ADD PENGUJI WAWANCARA // ADD PENGUJI WAWANCARA // ADD PENGUJI WAWANCARA
		...
		$jam = $_POST['postjam'];
		$tempat = $_POST['postlink'];
		$keterangan = $_POST['postket'];
		
		// add datapelamar dan datacv
		$conn->addwawancara($idwawancara, $idpendaftar, $idpenguji, $tgl, $jam, $tempat, $keterangan);
