...
include ('../db_gudang/mdl_requestbarang.php');
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="box box-primary">
             ...
             <!-- form start -->
                    <form role="form" action="../controller_gudang/requestbarangcontroller.php?action=addrequestbarang" Method="POST">
                <div class="box-body">
                     
                     <label for="fornama">ID List Bahan</label>
                     <div class="form-group input-group">
                      <select style="width : 400px;" name="postid_listbarang" class="form-control">
                        <?php
                        
                        $read = $conn->drolistbarang();
                        while ($fetch = $read->fetch_array()){
                          ?>
                          <option value="<?php echo $fetch['id_listbarang']?>">
                            <?php echo $fetch['id_listbarang'].'  ' ?></option>
                        <?php
                        }
                        ?>
                      </select>
                     ...
                     <div class="form-group input-group">
                      <select style="width : 400px;" name="postnama_barang" class="form-control">
                        <?php
                        $read = $conn->drolistbarang();
                        while ($fetch = $read->fetch_array()){
                          ?>
                          <option value="<?php echo $fetch['id_listbarang']?>">
                            <?php echo $fetch['nama_barang'].'  ' ?></option>
                        <?php
                        }
                        ?>
                      </select>
