<?php
	require_once '../db_suplayer/mdl_barang.php';
	$conn = new mdlbarang();
	...
	if($action == "tambah"){	
			...
			header('location:../suplayer/data-barang.php');
			...
			$action = "Add Data";
			$keterangan = "Data yang telah di hapus adalah data dengan id_barangsup ".$_GET['postid'] ." dan Berikut detailnya : <br/>" ."
...
harga : " .$harga;
	...
	// Log Hapus
		...
		$query = mysqli_query($link, "SELECT * FROM tbbarangsuplayer WHERE id_barangsup = '" .$_GET['postid'] ."' ");
